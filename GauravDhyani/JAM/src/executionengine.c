...
/**
 * @brief Executes a JAM script from a given file.
 *
 * This function reads the contents of a JAM script file, initializes
 * the lexer, parses the source code into an abstract syntax tree (AST),
 * performs optional semantic analysis, and executes the parsed program.
 *
 * @param filename The path to the .jam script file to execute.
 * @return int Returns 0 on success, or 1 on failure (e.g., file not found,
 *             parse error, etc.).
 */
